...
\begin{frame}\frametitle{A systematic approach} 
	...
	\begin{columns}[T]
		...
		\column{0.5\textwidth}
			\onslide+<3->{
				\includegraphics[width=.9\textwidth]{\imagedir/doe/screenshot-of-DOE-template.png}
...
\end{frame}
\begin{frame}\frametitle{}
	\centerline{\includegraphics[height=.8\textheight]{\imagedir/doe/ofat-vs-full-factorial-3-factors-full-factorial.png}}
\end{frame}
\begin{frame}\frametitle{}
