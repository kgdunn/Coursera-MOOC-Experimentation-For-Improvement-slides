...
{\usebackgroundtemplate{\vbox to \paperheight{\vfil\hbox to \paperwidth{\hfil  
	...
	{../3B/Slides/15Screen Shot 2015-07-17 at 12.55.12 .png}  \hfil}\vfil}}
...
{\usebackgroundtemplate{\vbox to \paperheight{\vfil\hbox to \paperwidth{\hfil  
    \includegraphics[width=0.95\paperwidth,trim=0 1.69cm 0 1.69cm, clip]
	{../3B/Slides/16Screen Shot 2014-07-16 at 07.18.03 .png}  \hfil}\vfil}}
\begin{frame}\frametitle{}
\end{frame}}

{\usebackgroundtemplate{\vbox to \paperheight{\vfil\hbox to \paperwidth{\hfil  
    \includegraphics[width=0.95\paperwidth, clip]
	{../3B/Slides/17Screen Shot 2015-07-17 at 12.58.57 .png}  \hfil}\vfil}}
\begin{frame}\frametitle{}
\end{frame}}
