...
\documentclass[11pt,mathserif,handout]{beamer}  % For 4:3 aspect ratio slides
...
%\subtitle[]{\vspace{0.5cm} \includegraphics[width=0.2\textwidth]{\imagedir/teaching/logos/4C3-logo-2015.png} \vspace{-1.5cm} }\author[]{}
\institute[]{}
\date[]{\copyright~ Kevin Dunn, \today \\ \vspace{0cm}
{{\footnotesize {\tt } \href{http://learnche.org/}{http://learnche.org/}\\} \vspace{0.5cm}}

{\LARGE \color{blue}{Design and Analysis of Experiments}}
...
% \institute[]{}
% \date[]{\copyright~ Kevin Dunn, \today \\ \vspace{0cm}
% {{\footnotesize {\tt kevin.dunn@mcmaster.ca}\\ \href{http://learnche.mcmaster.ca/}{http://learnche.mcmaster.ca/}\\} \vspace{0.5cm}}
%
% %{\footnotesize Overall revision number: \hgversion (\monthname~\THEYEAR)} %\twodigit{\THEDAY}-\twodigit{\THEMONTH}-
%
% {\LARGE \color{blue}{Least Squares Modelling}
...
% 		\begin{center}
% 			{\Large \href{http://learnche.org/feedback-questions}{http://learnche.mcmaster.ca/feedback-questions}}
% 		\end{center}
% 	\end{exampleblock}
% 	\vskip12pt
