...
\begin{frame}\frametitle{\LARGE Design and Analysis of Experiments - An Overview }
	...
	\centerline{\includegraphics[width=0.5\textwidth]{\imagedir/teaching/logos/Coursera-MOOC-logo-2014.png}}
	...
	\begin{exampleblock}{}
		...
		\begin{itemize}
			...
			\item	a sheet of paper, and a pen [{\color{purple} \emph{please fetch these while we wait to get started}}]
		\end{itemize}
	\end{exampleblock}
...
\begin{frame}\frametitle{Some important terminology}
	...
	\textbf{{\color{purple} Factors = Variables}}
		...
		\begin{columns}[T]
			\column{0.5\textwidth}
				\centerline{Numeric  \newline	 \includegraphics[width=0.5\textwidth]{\courseradir/1B/Supporting-material/water.png}}
				\onslide+<2->{
					\vspace{0.25cm}
					\centerline{\includegraphics[height=1cm]{\imagedir/doe/screenshots/numeric-factor.png}}			
				}
				
			\column{0.5\textwidth}
				\centerline{Categorical \newline \includegraphics[width=0.5\textwidth]{\courseradir/1B/Supporting-material/fertilizer.png}}			
				\onslide+<2->{
					\vspace{0.25cm}
					\centerline{\includegraphics[height=1cm]{\imagedir/doe/screenshots/categorical-factor.png}}			
				}				
		\end{columns}
...
\begin{frame}\frametitle{Some important terminology}
	\begin{columns}[T]
		...
		\column{0.3\textwidth}
			\alt<4>{\centerline{\includegraphics[width=1.2\textwidth]{\imagedir/doe/screenshots/response-and-objective.png}}}{\centerline{\includegraphics[width=0.8\textwidth]{\courseradir/1B/Supporting-material/plant.jpg}}}			
	\end{columns}
\end{frame}
...
% Heavy interaction example
\begin{frame}\frametitle{}
	\centerline{\includegraphics[height=.8\textheight]{\imagedir/doe/interaction-plot-2-factors-OFAT-baseline-01.png}}
\end{frame}
\begin{frame}\frametitle{}
	\centerline{\includegraphics[height=.8\textheight]{\imagedir/doe/interaction-plot-2-factors-OFAT-baseline-02.png}}
\end{frame}
\begin{frame}\frametitle{}
	\centerline{\includegraphics[height=.8\textheight]{\imagedir/doe/interaction-plot-2-factors-OFAT-baseline-03.png}}
\end{frame}
\begin{frame}\frametitle{}
	\centerline{\includegraphics[height=.8\textheight]{\imagedir/doe/interaction-plot-2-factors-OFAT-baseline-04.png}}
\end{frame}
\begin{frame}\frametitle{}
	\centerline{\includegraphics[height=.8\textheight]{\imagedir/doe/interaction-plot-2-factors-OFAT-baseline-05.png}}
\end{frame}
\begin{frame}\frametitle{}
	\centerline{\includegraphics[height=.8\textheight]{\imagedir/doe/interaction-plot-2-factors-OFAT-baseline-06.png}}
\end{frame}
\begin{frame}\frametitle{}
	\centerline{\includegraphics[height=.8\textheight]{\imagedir/doe/interaction-plot-2-factors-OFAT-baseline-07.png}}
\end{frame}
\begin{frame}\frametitle{}
	\centerline{\includegraphics[height=.8\textheight]{\imagedir/doe/interaction-plot-2-factors-OFAT-baseline-08.png}}
\end{frame}
\begin{frame}\frametitle{}
	\centerline{\includegraphics[height=.8\textheight]{\imagedir/doe/interaction-plot-2-factors-OFAT-baseline-09.png}}
\end{frame}
\begin{frame}\frametitle{}
	\centerline{\includegraphics[height=.8\textheight]{\imagedir/doe/interaction-plot-2-factors-OFAT-baseline-10.png}}
\end{frame}

% Interactions
\begin{frame}\frametitle{Understanding interactions: water and soap example}
	\begin{center}
		\includegraphics[width=0.9\textwidth]{\imagedir/doe/examples/hand-washing-flickr-7008312299_2fcf07309c_k.jpg}
	\end{center}
	\vspace{-4cm}
...
\begin{frame}\frametitle{Cell-culture example: long duration runs; and many factors are possible}
	\begin{columns}[c]
		...
		\column{0.5\textwidth}
			...
			\centerline{\includegraphics[height=.7\textwidth]{\courseradir/4F/Supporting material/flickr-3815183191_98c6296080_b-cell-culture-instrumentation.jpg}}
