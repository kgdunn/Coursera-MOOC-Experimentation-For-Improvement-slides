...
\institute[]{}
\date[]{Kevin Dunn and Arnold Wilbers, 21 April \today \\ \vspace{1cm}
...
\begin{frame}\frametitle{A systematic approach} 
	\begin{columns}[T]
		\column{0.6\textwidth}
			...
			\item	Plan the experiment {\small (\href{https://yint.org/template}{link to template})}\pause
...
\begin{frame}\frametitle{The 5 goals for any data analysis work}
	...
	\vspace{-20pt}
	\onslide+<6->{
		\includegraphics[width=0.3\textwidth]{\imagedir/doe/examples/advice-logo.png} {\color{blue}Always have a clear objective in mind}
	}
